/**
 * Medico Grid Controller
 * mario@webintegral.com.co
 * 
 * This controller handles Medico Data Grid, search, select, create, edit and delete.
 */
(function() {
	'use strict';
	...
	angular
		...
		.controller('CpMedicoGridCtr', CpMedicoGridCtr);
	
	CpMedicoGridCtr.$inject = ['$scope', 'acl', '$q', '$state', '$stateParams', 'MedicoResource', 'uiGridConstants', '$uibModal'];		//~
	
	function CpMedicoGridCtr($scope, acl, $q, $state, $stateParams, Resource, uiGridConstants, $uibModal) {		//~
    	...
    	var cellTmpBoolean = '<div><div class="ui-grid-cell-contents"><i ng-show="row.entity[col.field]" class="fa fa-check" aria-hidden="true"></i><i ng-show="!row.entity[col.field]" class="fa fa-times" aria-hidden="true"></i></div></div>'
    	...
    	$scope.columns = [
    		...
    		{name: 'Nombre', field: 'nombre', visible: true, enableSorting: true, cellTemplate: cellTemplate},
       		{name: 'Especialidad', field: 'especialidad', visible: true, enableSorting: true, cellTemplate: cellTemplate},
    		{name: 'Activo', field: 'activo', visible: true, enableSorting: true, cellTemplate: cellTmpBoolean}
    	 ...
    	 */
    	function create() {
    		$state.go('main.medico.edit', {medicoId: 'new'});	//~
    	} // create
    	...
    	function rowClick(row) {
    		// Go to edit row
    		$state.go('main.medico.edit', {medicoId: row.entity.id});	//~
    	} // rowClick
