...
class ExamenParametroResource extends AbstractResourceListener
{
    /**
     * Main entity class string
     * @var string
     */
    const ENTITY_CLASS = 'CPIpsAPI\V1\Rest\ExamenParametro\ExamenParametroEntity';    //~
    ...
    public function create($data)
    {
        ...
        $entity = new ExamenParametroEntity();
